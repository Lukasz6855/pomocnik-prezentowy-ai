# Polityka prywatności serwisu "Pomocnik Prezentowy AI"
...
**Łukasz Sachmerda**  
adres e-mail: sachmerda@gmail.com
...
**2.1. Dane podawane dobrowolnie w formularzu generowania propozycji prezentów:**
...
- adres wywoływanego endpointu (np. `/api/generuj`)

**Uwaga:** Serwis **nie** przetwarza danych umożliwiających bezpośrednią identyfikację konkretnej osoby (np. imię i nazwisko obdarowywanego, PESEL itd.).
...
**3.1. Generowanie propozycji prezentów**
...
Dane techniczne (logi serwera) są używane do:
...
## 4. Korzystanie z zewnętrznych usługodawców
...
Serwis może być utrzymywany na infrastrukturze zewnętrznego dostawcy (np. dostawca hostingu, chmura obliczeniowa). Dostawca ten ma potencjalny dostęp do danych zapisanych na serwerach, ale przetwarza je zgodnie z zawartą umową powierzenia.
...
**5.1. Dane z formularza wykorzystywane do wygenerowania propozycji prezentów:**
...
**5.2. Dane techniczne (logi serwera):**
...
Administrator stosuje odpowiednie środki techniczne i organizacyjne zapewniające ochronę przetwarzanych danych, w szczególności przed ich utratą, modyfikacją, nieuprawnionym dostępem lub ujawnieniem.

Dane przesyłane do serwisu są chronione poprzez szyfrowanie (HTTPS).
